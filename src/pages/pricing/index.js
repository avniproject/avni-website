                ...
                <div className="columns is-mobile is-multiline">
                    <div className="column is-one-third-tablet is-10-mobile is-offset-1-mobile">
                        <div className="content has-background-grey-lighter" style={{padding: '1em', minHeight: '30em'}}>
                            ...
                            <ol style={{paddingLeft: '1em', paddingRight: '1em'}}>
                                <li>Up to 20 users, 5k forms per month, 500GB storage: <span className="has-text-weight-semibold">₹10,000/- per month</span> (paid upfront annually)</li>
                                <li>Up to 100 users:, 10k forms per month, 1TB storage: <span className="has-text-weight-semibold">₹15,000/- per month</span> (paid upfront annually)</li>
                    ...
                    <div className="column is-one-third-tablet is-10-mobile is-offset-1-mobile">
                        <div className="content has-background-grey-lighter" style={{padding: '1em', minHeight: '30em'}}>
                            ...
                            <p className="is-size-6 has-text-weight-bold">Avni Cloud Hosting (After first month)</p>
                            <ol style={{paddingLeft: '1em', paddingRight: '1em'}}>
                                <li>Up to 20 users, 5k forms per month, 200GB storage: <span className="has-text-weight-semibold">₹10,000/- per month</span> (paid upfront annually)</li>
                                <li>Up to 100 users:, 10k forms per month, 1TB storage: <span className="has-text-weight-semibold">₹15,000/- per month</span> (paid upfront annually)</li>
                                <li>More than 100 users: Custom quote</li>
                            </ol>
                            <p className="control full-centered">
                    ...
                    <div className="column is-one-third-tablet is-10-mobile is-offset-1-mobile">
                        <div className="content has-background-grey-lighter" style={{padding: '1em', minHeight: '30em'}}>
                            ...
                            <ol style={{paddingLeft: '1em', paddingRight: '1em'}}>
                                <li>Up to 20 users, 5k forms per month, 200GB storage: <span className="has-text-weight-semibold">₹7,000/- per month</span> (paid upfront annually)</li>
                                <li>Up to 100 users, 10k forms per month, 1TB storage: <span className="has-text-weight-semibold">₹10,000/- per month</span> (paid upfront annually)</li>
                                <li>More than 100 users: Custom quote</li>
                            </ol>
                            <p className="control full-centered">
