...
title: "T4D AI Cohort 2 : Resuming the Avni AI journey"
date: 2026-03-01T12:30:00.000Z
author: Himesh R
description: A personal account of the T4D AI Cohort 2 in Rishikesh — exploring AI possibilities for Avni, forging new bonds, and finding moments of bliss.
featuredpost: false
featuredimage: /img/2026-03-02-ai-cohort-2-rishikesh/Ganga-rishikesh.jpg
tags:
  - AI
  - Tech4Dev
  - Social Impact
...
## Contact, Meandering and Story narration
...
## Presentations, Resuming the AI journey and Forging new bonds
...
1. How we could solve the Voice-to-text problem for auto-filling Avni forms?
2. Analyzing the feasibility of offline SLMs for Avni Field APP integration
3. Evaluating Google Cloud native support for building full fledged AI assistant for Avni.

Whilst I interacted with the Kaapi team on how to integrate
1. Guardrails into Avni AI Assistant Dify Workflows
2. Using latest AI tooling for defining Scoping documentation and generating Avni implementation Config.
...
- The Avni Templates capability and
- The Avni AI Assistant
...
- Template application : Not Intuitive and some of the templates failed on application
- AI Assistant : The responses were not always in the context of Avni Implementer, due to pollution of Knowledge Base with Developer Documentation. This seemed to have been caused due to semi-automation of Knowledge base refresh with Avni Readme, where we forgot to take away Avni Developer documentation content.
- General quality of AI features implemented, where we hadn't thoroughly tested what we had built.
...
## Getting hands Dirty and Behavioural change
...
![Neelkanth Hill - Hike Photo](/img/2026-03-02-ai-cohort-2-rishikesh/hiking.jpg)

## Review of Avni AI journey and the path ahead
...
##  Return to civilization and Overtaking cars on foot
